...
Browse step-by-step tutorials for common CacheerPHP tasks:

- [Example 01 — Simple Data Cache](./example-01-simple-data-cache.md)
- [Example 02 — Custom Expiration (TTL)](./example-02-custom-expiration-ttl.md)
- [Example 03 — Cleaning and Flushing](./example-03-cleaning-and-flushing.md)
- [Example 04 — Namespaces](./example-04-namespaces.md)
- [Example 05 — API Response Cache](./example-05-api-response-cache.md)
- [Example 06 — JSON Output Formatter](./example-06-json-output-formatter.md)
- [Example 07 — Array Output Formatter](./example-07-array-output-formatter.md)
